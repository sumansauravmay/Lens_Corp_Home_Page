            ...
            <Testimonial>
              <TestimonialContent>
                ...
                >
                  <TestimonialHeading>
                    <Flex width={"full"}>
                      <Text class="text-black text-3xl mt-2">
                        Exclusive Rights
                      </Text>
                    </Flex>
                  </TestimonialHeading>
            ...
            <Testimonial>
              <TestimonialContent>
                ...
                >
                  ...
                  <TestimonialText>
                    We regularly benchmark our solutions via comparing
                    industry-vide evaluations so our partners only get the best
                    that AI can offer.
                  </TestimonialText>
                </Container>
              </TestimonialContent>
            ...
            <Testimonial>
              <TestimonialContent>
                ...
                >
                  ...
                  <TestimonialText>
                    We provide AI-driven solutions into businesses where they
                    can bring tangible value. Each solution is customized as per
                    your needs and deployed on any computing device of your
                    choice.
                  </TestimonialText>
                </Container>
              </TestimonialContent>
            ...
            <Testimonial>
              <TestimonialContent>
                ...
                >
                  ...
                  <TestimonialText>
                    Should you face any issues, we are always at your service.
                    We provide lifetime technical support & upgrade options.
                  </TestimonialText>
                </Container>
              </TestimonialContent>
            </Testimonial>
