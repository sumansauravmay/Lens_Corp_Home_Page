...
const TestimonialHeading = ({ children }) => {
  return (
    <Heading as={"h3"} fontSize={"xl"} mt="50px">
      {children}
    </Heading>
  );
};
                ...
                >
                  <TestimonialHeading>
                    <Flex width={"full"}>
                      ...
                      <Text class="text-green-500 text-3xl mt-2">
                        Biometrics
                      </Text>
                    </Flex>
                  </TestimonialHeading>
                  <TestimonialText>
                    ...
                    automated Biometric applications on edge devices even
                ...
                >
                  <TestimonialHeading>
                    <Flex width={"full"}>
                      ...
                      <Text class="text-blue-500 text-3xl mt-2">
                        Image Analysis
                      </Text>
                    </Flex>
                  </TestimonialHeading>
                ...
                >
                  <TestimonialHeading>
                    <Flex width={"full"}>
                      ...
                      <Text class="text-red-600 text-2xl mt-2 absolue left-2">
